import Modal from '@/components/Portuguese/ContactModal';
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.bottomContent}>
                        <div className={styles.textContent}>
                            ...
                            <p>
                                Nossa empresa é especialista na criação de
                                sites, com o objetivo de aumentar o faturamento
                                de nossos clientes.
                            </p>
                            <p>
                                Temos uma equipe especializada em SEO, Marketing
                                Digital e Criação de sites, fazemos integração
                                com pixel, gtm e assim por diante.
                            </p>
                            <p>
                                Aumente o faturamento de sua empresa, entre em
