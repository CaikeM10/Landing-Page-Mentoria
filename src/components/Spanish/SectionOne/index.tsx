        ...
        <div className={styles.content}>
          <ScrollAnimation animateIn="fadeIn">
            <div className={styles.leftside}>
              ...
              <h5>
                Aprenda con quien vive lo que dice, a hacer de su casa con quien
                va a mudar su vida! usted ya puede empezar hoy haciendo paginas
                de su casa y ganar mas de 10 mil reales por mes apartir de los
                proximos 30 dias.
              </h5>
