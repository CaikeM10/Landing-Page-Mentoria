        ...
        <div className={styles.content}>
          <InView threshold={0.5} triggerOnce={false}>
            {({ inView, ref }) => (
              ...
              >
                ...
                <h5>
                  Vuelvase un programador y cambie su vida creando pagina y
                  landing pages!
                </h5>
              </motion.div>
            )}
          ...
          <InView threshold={0.5} triggerOnce={false}>
            {({ inView, ref }) => (
              ...
              >
                ...
                <div className={styles.modulesResponsive}>
                  <img src="/smallCheck.svg" />
                  <p>Módulo 04: Programacion desde zero al pro </p>
                </div>
                <div className={styles.modulesResponsive}>
                  <img src="/smallCheck.svg" />
          ...
          <InView threshold={0.5} triggerOnce={false}>
            {({ inView, ref }) => (
              ...
              >
                {" "}
                <h3>recuerda todo lo que usted va a tener acceso ahora:</h3>
                ...
                <div className={styles.modules}>
                  <img src="/smallCheck.svg" />
                  <p>Módulo 04: Programacion de zero al pro </p>
                </div>
                <div className={styles.modules}>
                  <img src="/smallCheck.svg" />
                  <p>Módulo 05: Anuncios online </p>
