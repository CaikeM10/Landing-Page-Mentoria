...
import Squares1 from "@/components/Portuguese/Squares/Square1";
import Squares2 from "@/components/Portuguese/Squares/Square2";
import Squares3 from "@/components/Portuguese/Squares/Square3";
import Squares4 from "@/components/Portuguese/Squares/Square4";
import Squares5 from "@/components/Portuguese/Squares/Square5";
import Squares6 from "@/components/Portuguese/Squares/Square6";
import Squares7 from "@/components/Portuguese/Squares/Square7";
        ...
        <section className={styles.container} style={{ color: textColor }}>
          <div className={styles.content}>
            <div className={styles.title}>
              <h2>
                <span className={styles.auroraSpan}> MODULOS EXCLUSIVOS</span>
              </h2>
            </div>
