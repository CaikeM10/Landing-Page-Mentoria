      ...
      <div className={styles.content}>
        <div className={styles.top}>
          ...
          <div className={styles.rightside}>
            ...
            <p>
              Você pode ver todo o Protocolo por dentro e, caso perceba que não
              faz sentido para o seu momento, basta me enviar um e-mail e eu vou
        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.info}>
            ...
            <div className={styles.text}>
              ...
              <p>Compre e assista quando quiser. Não tem renovação.</p>
            </div>
          </div>
        </div>
      </div>
